...
function NoGroupStudent() {
  ...
  const deleteStudent = () => {
    ...
    http
      .post(
        import.meta.env.VITE_API_URL + `api/student_pending/delete/${data[4]}`,
        {
  ...
  const messSubmit = (id) => {
    if (textAreaCount && !/^\s*$/.test(textAreaCount)) {
      if (textAreaCount.length >= 4) {
        ...
        http
          .post(import.meta.env.VITE_API_URL + 'api/message/add/one', {
            student_id: id,
            text: textAreaCount,
        ...
        skeletonTime ? (
          ...
          student && (
            <div>
              <Header>
                <div>
                  <h3>{(student.firstname.length > 30 ? `${student.firstname.slice(0, 30)}...` : student.firstname) + ' ' + (student.lastname.length > 30 ? `${student.lastname.slice(0, 30)}...` : student.lastname)} ma&apos;lumotlari</h3>
                </div>
                <div className="action_right">
                  ...
                  <Tooltip
                    ...
                    placement="top"
                  >
                    <Link to={`/update-not-group-student/${student.id}`}>
                  ...
                  <table>
                    <tbody>
                      <tr>
                        ...
                        <td style={{ display: 'inline-block', width: '250px', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                          {student.firstname +
                            ' ' +
                            student.lastname +
                            ' ' +
                      ...
                      <tr>
                        <td>Otasini telefonni: </td>
                        <td>{student.fatherPhone}</td>
                      </tr>
                      <tr>
                        <td>Onasini telefonni: </td>
                  ...
                  >
                    <AllGroupsDeleteModal>
                      ...
                      <div className="allGroups_delete_notification_part">
                        <p>
                          Rostdan ham ushbu{' '}
                          {(student.firstname.length > 20 ? `${student.firstname.slice(0, 20)}...` : student.firstname) + ' ' + (student.lastname.length > 20 ? `${student.lastname.slice(0, 20)}...` : student.lastname)}{' '}
